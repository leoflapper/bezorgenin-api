...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Login om uw restaurants te beheren</p>
        ...
        <a href="{{ url('/password/reset') }}">Ik ben mijn wachtwoord vergeten</a><br>
        <a href="{{ url('/register') }}" class="text-center">Nieuw account registreren</a>
